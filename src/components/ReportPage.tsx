...
import { categories, getCategoryMeta } from "../../src/constants/categories";
...
export default function ReportPage({ transactions, accounts, onBack }: Props) {
  ...
  const [datePreset, setDatePreset] = useState<number | null>(0); // offset or null=custom
  ...
  const totalExpense = summary.expense || 1; // avoid div/0
